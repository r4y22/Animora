...
/**
 * This class represents the "Load Game Tutorial" pop-up screen of the Animora
 * game.
 * It provides a tutorial for users on how to load a saved game and continue
 * their journey.
 ...
 * @since 1.0
 */
public class LoadGameTutorialScreen extends Application {
    ...
    /**
     * Creates the "Load Game Tutorial" screen.
     * 
    ...
    public Scene createScene(Stage stage) {
        ...
        Label sub_title = new Label("Load Game ");
        Label welcome_msg = new Label("Welcome to the world of Animora!");
        Label howTo_msg = new Label("Load game to continue your journey where you left off");
        ...
        ImageView loadGameTut = new ImageView(
                getClass().getResource("Assets/Images/loadGameTut.gif").toExternalForm());
        loadGameTut.setPreserveRatio(true);
        loadGameTut.setFitWidth(500);
        loadGameTut.setFitHeight(300);
        loadGameTut.setTranslateX(0);
        loadGameTut.setTranslateY(80);
        ...
        // Create and configure a next button to navigate to the "Game Over Tutorial"
        // screen.
        ...
        nextButton.setOnAction(event -> {
            try {
                Scene gameOverTutorialScreen = new GameOverTutorialScreen().getScene(stage);
                stage.setScene(gameOverTutorialScreen);
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        root.getChildren().addAll(page_title, sub_title, welcome_msg, cancelButton, howTo_msg, nextButton, loadGameTut,
                backgroundView);
    ...
    /**
     * Gets the scene for the "Load Game Tutorial" screen.
     * 
     * @param stage The primary stage for this application.
     * @return The scene to be displayed on the stage.
     */
